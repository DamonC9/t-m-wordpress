...
function rebelmouse_register_mysettings() {
    ...
    register_setting( 'rebelmouse-settings-group', 'rebelmouse_columns' );
                ...
                <li>
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li> 'skip' help you to hide modules (only for <a href="https://www.rebelmouse.com/core/users/pricing/">premium sites</a>)
                                <ul>
                                    <li>
...
<form method="post" action="options.php">
    ...
    switch ( $tab ){
        case 'homepage' : 
            ...
            $rebelmouse_columns         = get_option('rebelmouse_columns', '4');
		...
		case 'page' :  
            ...
            <p class="submit">
                <input type="hidden" id="rebelmouse-page-features" name="rebelmouse_premium" value="<?php echo $rebelmouse_premium ?>"/>
 ...
 */
function rebelmouse_add_page( $site_name, $page_title, $columns, $skip) {
...
if ( isset($_POST['action']) && $_POST['action'] == 'update' && wp_verify_nonce( $_POST['rebelmouse_noncename'], plugin_basename( __FILE__ ) ) ) {
    ...
    if ( $_POST['submit_button'] === translate( 'Add page' ) ){
        ...
        $rebelmouse_page_columns  = intval( esc_html( $_POST['rebelmouse_page_columns'] ) );

        $rebelmouse_hide_about      = $_POST['rebelmouse_page_hide_about'];
        $rebelmouse_hide_following  = $_POST['rebelmouse_page_hide_following'];
        $rebelmouse_hide_also_in_rm = $_POST['rebelmouse_page_hide_also_in_rm'];
        $rebelmouse_hide_join_rm    = $_POST['rebelmouse_page_hide_join_rm'];
        ...
        $page_id = rebelmouse_add_page($rebelmouse_page_sitename, $rebelmouse_page_title, $rebelmouse_page_columns, $skip);
        ...
        $rebelmouse_hide_about      = $_POST['rebelmouse_hide_about'];
        $rebelmouse_hide_following  = $_POST['rebelmouse_hide_following'];
        $rebelmouse_hide_also_in_rm = $_POST['rebelmouse_hide_also_in_rm'];
        $rebelmouse_hide_join_rm    = $_POST['rebelmouse_hide_join_rm'];
        ...
        //page only support 3 or 4 columns
        $rebelmouse_columns = intval( esc_html( $_POST['rebelmouse_columns'] ) );
        update_option('rebelmouse_columns', $columns );

        $page_id = rebelmouse_add_page($rebelmouse_sitename, $rebelmouse_sitename, $rebelmouse_columns, $skip);
